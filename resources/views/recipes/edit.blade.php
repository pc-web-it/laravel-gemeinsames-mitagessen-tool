<x-layout>
    <div class="max-w-lg mx-auto mt-8">
        <form action="/recipes/{{ $recipe->id }}" method="POST" enctype="multipart/form-data"
            ...
            <h1 class="neuesRezeptTitel text-center md:text-xl mt-5" style="font-size: 2rem;">Rezept bearbeiten</h1>
            ...
            <x-form-field>
                ...
                <textarea
                    ...
                    id="description" name="description" placeholder="Description">{{ $recipe->description }}</textarea>
            ...
            <div class="flex items-center justify-between mt-5">
                ...
                <a href="/recipes/{{ $recipe->id }}"
                    class="backBtn rounded-full inline-block align-baseline font-bold text-sm py-2 px-3"><img src="{{ asset('back2.jpg') }}" alt="Back" class="w-6 inline mr-2 mb-1">
                    Zurück
                </a>
            </div>
        </form>
